    ...
    render() {
        return (`
            <td class="ola_chartColumn-value" >
              ...
              <div class="ola_chartColumn-graphic" style="height:${parseInt(tokens('size-10')) * this.getAttribute('value')}px; background-color: ${tokens(this.getAttribute('color'))}; width:120px"></div>
            </td>
        `);
    }
}
